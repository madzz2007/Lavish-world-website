// ============================================
// LIGHTS PAGE - GOLDEN EDITION (FIXED)
// ============================================
...
(function() {
    ...
    // ---------- STATE ----------
    // FIXED: Now reads from the unified global 'staircaseCart' key
    ...
    function toggleTheme() {
        ...
        localStorage.setItem('lightsTheme', newTheme);
        updateThemeUI(newTheme);
        showToast(`Switched to ${newTheme} theme`, 'success');
    }

    function loadTheme() {
        const savedTheme = localStorage.getItem('lightsTheme') || 'dark';
    ...
    function addToCart(productId) {
        ...
        // Always pull latest data before modifying state
    ...
    function saveAndSyncCart() {
        // FIXED: Universal localstorage synchronization key
    ...
    // Navigation and Routing for Cart Button
    ...
    function init() {
        ...
        console.log('✨ Lights Page - Golden Edition initialized');
