// ============================================
// CHIMNEY PAGE - GOLDEN EDITION (FIXED)
// ============================================
...
(function() {
    ...
    // ---------- STATE ----------
    // FIXED: Switched from 'chimneyCart' to 'staircaseCart' for shared storage harmony
    ...
    function toggleTheme() {
        ...
        localStorage.setItem('chimneyTheme', newTheme);
        updateThemeUI(newTheme);
        showToast(`Switched to ${newTheme} theme`, 'success');
    }

    function loadTheme() {
        const savedTheme = localStorage.getItem('chimneyTheme') || 'dark';
    ...
    function addToCart(productId) {
        ...
        // Pull latest updates from localstorage before modifying state array
    ...
    function saveAndSyncCart() {
        // FIXED: Universal localstorage storage key synchronization
    ...
    // FIXED: Configured direct navigation link triggers for layout cart actions
    ...
    // Cross-tab data tracking broker
    ...
    function init() {
        ...
        console.log('✨ Chimney Page - Golden Edition initialized');
